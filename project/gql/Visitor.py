...
from project.automats import nfa_by_graph
from project.regular_queries import regular_path_querying_for_interpreter
...
class Visitor(GQLVisitor):
    ...
    def visitLambda(self, ctx: GQLParser.Lambda_exprContext):
        return self.visitChildren(ctx)

    def visitMap(self, ctx: GQLParser.MAP):
        return self.visitChildren(ctx)

    def visitFilter(self, ctx: GQLParser.FILTER):
        return self.visitChildren(ctx)
