...
def accept(inp: str) -> bool:
    """Check whether the input belongs to the language.
...
def save_as_dot(inp: str, file: Union[Path, str]):
    """Generate a description of the parse tree for a given input to a given file in DOT format.
